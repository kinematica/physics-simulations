...
// Beam one label
var beamOneLabelText = new Konva.Text({
...
// Beam two label
var beamTwoLabelText = new Konva.Text({
...
// Combined beam label
var beamCombLabelText = new Konva.Text({
...
dynamicLayer.add(beamOneLabelText);
dynamicLayer.add(beamTwoLabelText);
dynamicLayer.add(beamCombLabelText);
...
// This variable will always store the last pathDiff from the previous frame. In
...
var anim = new Konva.Animation( function(frame) {
	...
	if (launch === true) {
		...
		if (totalTime < 5) {
			...
			beamOneLabelText.x( (fullW / 1.25) + 10 + (49 * (params.deltaPathOne/316)));
			beamTwoLabelText.x( (fullW / 1.25) + 10	+ (49 * (params.deltaPathTwo/316)));
			beamCombLabelText.x( (fullW / 1.25) - 25 + (49 * (params.deltaPathOne/316)));			
