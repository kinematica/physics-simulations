...
var anim = new Konva.Animation( function(frame) {
	...
	if (launch === true) {
		...
		if (totalTime < 5) {
			...
			mirrorOne.y( (fullH / 1.5) - 320 - params.deltaPathOne/15);
			beamOneOut.y( (fullH / 1.5) - 110 - params.deltaPathOne/15);
			beamOneBack.y( (fullH / 1.5) - 309 - params.deltaPathOne/15);
	
			mirrorTwo.x( (fullW / 8) + 565 + params.deltaPathTwo/15);
			beamTwoOut.x( (fullW / 8) + 362 + params.deltaPathTwo/15);
			beamTwoBack.x( (fullW / 8) + 564 + params.deltaPathTwo/15);
			...
			beamOneCombIntImage.opacity(Math.ceil(Math.floor(pathDiff)/316))
