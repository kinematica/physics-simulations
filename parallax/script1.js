...
function radius()       {  return fullWidth() / 40;     }
...
// Get the vector pointing from earth center to star center
...
// Rotate the unit vector by +90 degrees and scale it to the earth's radius
function rup() {
    var rh = rhat();
    var rad = radius();
